...
<head>
    ...
    <title>Aplikasi Perjalanan Diri | Register</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Register Akun Aplikasi Perjalanan Diri</h1>
                                        <p>Silahkan Masukkan
                                            NIK dan Nama Lengkap Anda.</p>
                                    </div>
                                    <form class="user" method="post" action="proses_register.php">
                                        ...
                                        <a href="index.php" class="btn btn-facebook btn-user btn-block">
                                            <i class="fa fa-arrow-left fa-fw"></i> Login
                                        </a>
                                    </form>
