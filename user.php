...
<head>
    ...
    <title>Aplikasi Perjalanan Diri - User</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Perjalanan Diri</div>
            </a>
            <!-- Divider -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h3>Perjalanan Diri - Aplikasi Pencatatan Perjalanan</h3>
                </nav>
                <!-- End of Topbar -->
                <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="mb-4 text-gray-800">
                        ...
                        if (!empty(@$_GET['url'])) {
                            ...
                            echo "Selamat Datang Di Aplikasi Perjalanan Diri, Aplikasi ini digunakan untuk Mencatat Riwayat Perjalanan.";
                            echo "<br>Anda Login Sebagai : ";
                            echo "<br><h4>" . $_SESSION['nama_lengkap'] . "</h4>";
                        }
                        ?>
                    </div>
                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; UKK RPL 2022 - Sterida</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
